// components/OriginProtocol.tsx
export default function OriginProtocol() {
    return (
      <section className=" protocol-section inline-block w-auto  px-6 py-8"
data-augmented-ui="
   tl-clip tr-2-clip-y t-clip-x r-clip br-2-clip-x bl-2-clip-x  both">
        ...
        <p className="text-[#9eeaf9] text-sm leading-relaxed font-light max-w-3xl">
          I didn’t start with code — I started with languages. Human ones. Then I discovered programming and realized it’s just another language… but with fewer bugs in grammar. <br /><br />
